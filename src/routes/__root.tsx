...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "me. — The blueprint of holistic self-stewardship" },
      { property: "og:description", content: "Faith, Mind, Body, Community. One ecosystem for becoming the truest version of you." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "me. — The blueprint of holistic self-stewardship" },
      { name: "twitter:description", content: "Faith, Mind, Body, Community. One ecosystem for becoming the truest version of you." },
